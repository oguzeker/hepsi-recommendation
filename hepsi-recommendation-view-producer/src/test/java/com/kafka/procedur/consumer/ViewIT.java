...
//
//    private  KafkaMessageListenerContainer<String, View> container;
//
//    @ClassRule
...
//        DefaultKafkaConsumerFactory<String, View> consumer = new DefaultKafkaConsumerFactory<String, View>(consumerProperties);
//
...
//        View message = View.builder().amount("10").transactionType("Auth").build() ;
